const AppConstants = {
  password: 'password',
  loginErrMsg:
    'You don’t have access to the administration platform. Please contact your Affiliated Organisation to re-activate your access.',
  ...
  userNameAndPassword:
    'Your Username is ${userName} and your Password is <b> ${password}</b>.<br><br>',
  ...
  registerBoforeCloseDate:
    '<br><br>It’s important that you register before the registration close date of $(registration_close_date). $(Competition_Name) starts on $(start_date).',
  PARENT_UNLINKED: 23,
  PARENT_LINKED: 9,
